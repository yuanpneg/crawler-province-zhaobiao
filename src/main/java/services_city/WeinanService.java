 ...
 * 渭南市
 */
public class WeinanService {

    private static final Logger LOGGER = Logger.getLogger(WeinanService.class); //使用log4j记录日志
        ...
        try {
            ...
            if (responseWrap.isSuccess()) {
                ...
                for (Element tr : trs) {
                    ...
                    String href = "http://www.wnggzy.com" + tr.select("a").attr("href");
                    ...
                    if (tit == 0) {
                        ...
                        tender.setAddress("渭南");
                        tender.setCatid(catid);
                        tender.setStatus(1);
                        tender.setFrom("渭南市公共资源交易中心");
                ...
                LOGGER.info("渭南市 请求列表为空");
            }
        } catch (Exception e) {
            LOGGER.info("渭南市 列表获取报错");
